        ...
        <div className="relative flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-bold text-white leading-tight">
              Kelola Keuangan
              <br />
              <span className="text-white/80">dengan Lebih Baik</span>
            </h1>
            <p className="text-white/70 text-base max-w-sm leading-relaxed">
              Platform manajemen keuangan untuk pribadi, UMKM, dan toko. Catat,
              pantau, dan evaluasi keuanganmu dalam satu tempat.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 text-white/50 text-sm">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full border-2 border-white/20 bg-white/10 flex items-center justify-center text-xs text-white font-medium"
                >
                  {["A", "B", "R", "S"][i - 1]}
                </div>
              ))}
        ...
        >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-3 text-muted">Atau</span>
            </div>
          </div>
